...
I know we just said that matrices don't commute! That is true, _generally_. However there are some examples of matrices commuting, even if not every pair of matrices being multiplied is commutative. This example isn't intuitive in numeric form so let's think about it visually.
